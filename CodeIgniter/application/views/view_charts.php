  ...
  <body>
	<div data-role="content">
		<div data-role="page" id="page" >
	  		...
	  		<?php echo $this->Charts_model->get_locations(); ?>
	        </select>
	        </div>
            ...
            <div data-role="fieldcontain">
              <!--<label for="selectmenu" class="select">Options:</label>-->
              <select name="selectmaxmin" id="selectmaxmin" data-native-menu="false">
                <option value="optionavg">Average only</option>
                <option value="optionall">Average Max and Min</option>
              </select>
            </div>

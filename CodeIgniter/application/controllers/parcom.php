...
class Parcom extends CI_Controller {

	function Parcom()
	{
		parent::__construct();
		
		$this->load->model('Parcom_model');
	...
	public function index()
	{
		...
		*/
		...
		$this->load->view('view_parcom', $this->view_data);
	}
	...
	public function select_instrument()
		{
			...
			$out = $this->Parcom_model->select_instrument($whatsup);
		...
		public function select_parameter($whatsup)
		{	
			//$whatsup = $this->uri->segment(3);
			
			$out = $this->Parcom_model->select_parameter($whatsup);
		...
		public function get_data($whatstat, $whatinstr, $whatpara, $nums)
		{
			...
			$out = $this->Parcom_model->get_data($whatstat, $whatinstr, $whatpara, $nums);
		...
		public function get_datam($whatinstr, $whatpara, $nums)
		{
			
			$out = $this->Parcom_model->get_datam($whatinstr, $whatpara, $nums);

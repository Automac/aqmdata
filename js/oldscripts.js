...
// See README.txt for more information.
	...
	$(document).bind("pageinit",function(){
			...
			$("select#sel_station").bind("change",function(){
				...
				$.post("select_instrument.php", {id:id}, function(data){
			...
			$("select#sel_instrument").bind("change",function(){
				...
				$.post("select_parameter.php", {id:id}, function(data){
				...
				//$.post("get_data.php", {stat:stat, instr:instr, para:para }, function(data){
					//$(document).on('pageshow', '#page2', function(){    
					    $(document).ready(function() {
							...
							//This data is obtained by exporting a GA custom report to numdata.
							//http://api.jquery.com/jQuery.get/
							jQuery.get('get_data.php', null, function(numdata) {
								var line = [];
								value = [];
								try {
								...
								options.series[0].numdata = value;
